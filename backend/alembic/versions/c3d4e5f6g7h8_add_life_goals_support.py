...
def upgrade() -> None:
    ...
    op.alter_column("goals", "start_date", existing_type=sa.DATE(), nullable=True)
    op.alter_column("goals", "end_date", existing_type=sa.DATE(), nullable=True)
...
def downgrade() -> None:
    ...
    op.create_check_constraint(
        "ck_goal_type", "goals", "goal_type IN ('daily', 'weekly', 'monthly', 'yearly')"
    )
    op.create_check_constraint(
        "ck_goal_status",
        "goals",
    ...
    op.alter_column("goals", "start_date", existing_type=sa.DATE(), nullable=False)
    op.alter_column("goals", "end_date", existing_type=sa.DATE(), nullable=False)
